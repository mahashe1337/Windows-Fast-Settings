...
TITLE VBS-HyperVisor-Protected Code Integity Disabler %DATE% %TIME%
echo ==== VBS-HyperVisor-Protected Code Integity Disabler %DATE% %TIME% ====
:: 1) Выключить VBS
...
echo ==== VBS-HyperVisor-Protected Code Integity Disabler END %DATE% %TIME% ====
exit